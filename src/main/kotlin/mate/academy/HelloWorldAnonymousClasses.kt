...
class HelloWorldAnonymousClasses {
    ...
    fun sayHello(names: List<String>): List<String> {
        ...
        val listOfGreeting : MutableList<String> = mutableListOf(englishGreeting.greet(),
            frenchGreeting.greet(),
            spanishGreeting.greet())

        for (name in names) {
            listOfGreeting.add(englishGreeting.greetSomeone(name))
            listOfGreeting.add(frenchGreeting.greetSomeone(name))
            listOfGreeting.add(spanishGreeting.greetSomeone(name))
        }
